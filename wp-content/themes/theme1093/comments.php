...
<?php if ( have_comments() ) : ?>
	...
	<div class="title-page03">
		<h3 id="comments" style=" padding-bottom:0;"><?php comments_number(_e('No Responses'), _e('One Response'), '% Responses' );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
	</div>
...
<div class="text-box">
                ...
                <?php else : ?>
                            ...
                            <p><input name="submit" type="image" src="<?php bloginfo('stylesheet_directory'); ?>/images/submit.png" id="submit" tabindex="5" value="Enviar" />
